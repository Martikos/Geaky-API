...
compare = (old_user, new_user, callback) ->
  if old_user.name is new_user.name and old_user.login is new_user.login and old_user.blog is new_user.blog and old_user.gravatar is new_user.gravatar and old_user.followers is new_user.followers and old_user.following is new_user.following and old_user.stars is new_user.stars and old_user.repos is new_user.repos and old_user.url is new_user.url
    return true
  else
    return false
